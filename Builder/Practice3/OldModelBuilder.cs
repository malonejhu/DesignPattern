...
{
    internal class OldModelBuilder : BaseModelBuilder, IModelBuilder
    {
        public OldModelBuilder(string oldModel, string customerCode) : base(oldModel, customerCode)
        {
        }
        ...
        public string GenerateModelForQuery(string coolingType, string generationCode, string PSUCode)
        {
            ModelPartList.Add(coolingType + generationCode + PSUCode + "_");
        ...
        {
            ModelPartList.Add(coolingType + generationCode + PSUCode + SKUCode);
            return this;
        }
        ...
        public OldModelBuilder ClearModelPart(params string[] removeValue)
        {
